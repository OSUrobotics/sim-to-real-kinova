...
let StageResult = require('./StageResult.js');
...
class StageActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StageResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StageActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = StageResult.Resolve(msg.result)
    }
    else {
      resolved.result = new StageResult()
    }
...
module.exports = StageActionResult;
