...
class SetFingersPositionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetFingersPositionResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetFingersPositionResult(null);
...
module.exports = SetFingersPositionResult;
