...
class Arm_KinovaPoseFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Arm_KinovaPoseFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Arm_KinovaPoseFeedback(null);
...
module.exports = Arm_KinovaPoseFeedback;
