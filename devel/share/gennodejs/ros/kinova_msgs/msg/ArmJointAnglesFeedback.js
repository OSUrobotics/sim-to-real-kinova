...
class ArmJointAnglesFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArmJointAnglesFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArmJointAnglesFeedback(null);
...
module.exports = ArmJointAnglesFeedback;
