...
class SetFingersPositionGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetFingersPositionGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetFingersPositionGoal(null);
...
module.exports = SetFingersPositionGoal;
