...
"""autogenerated by genpy from infrastructure_msgs/StageActionResult.msg. Do not edit."""
import codecs
import sys
...
class StageActionResult(genpy.Message):
  _md5sum = "c0d55a7d683fb31f2cdf9cdb79b70ff2"
  _type = "infrastructure_msgs/StageActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','infrastructure_msgs/StageResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StageActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = infrastructure_msgs.msg.StageResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = infrastructure_msgs.msg.StageResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.stage_result,) = _get_struct_B().unpack(str[start:end])
      self.result.stage_result = bool(self.result.stage_result)
      return self
