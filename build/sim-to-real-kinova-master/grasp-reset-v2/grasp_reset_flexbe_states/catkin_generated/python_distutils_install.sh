...
echo_and_run cd "/home/nigel/kinova_ws/src/sim-to-real-kinova-master/grasp-reset-v2/grasp_reset_flexbe_states"
...
echo_and_run /usr/bin/env \
    ...
    "/home/nigel/kinova_ws/src/sim-to-real-kinova-master/grasp-reset-v2/grasp_reset_flexbe_states/setup.py" \
     \
    build --build-base "/home/nigel/kinova_ws/build/sim-to-real-kinova-master/grasp-reset-v2/grasp_reset_flexbe_states" \
    install \
    --root="${DESTDIR-/}" \
