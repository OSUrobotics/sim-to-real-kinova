#ifndef _ROS_SERVICE_ClearTrajectories_h
#define _ROS_SERVICE_ClearTrajectories_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char CLEARTRAJECTORIES[] = "kinova_msgs/ClearTrajectories";

  class ClearTrajectoriesRequest : public ros::Msg
  {
    public:

    ClearTrajectoriesRequest()
    {
    }
    ...
    virtual const char * getType() override { return CLEARTRAJECTORIES; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class ClearTrajectoriesResponse : public ros::Msg
  {
    public:
